...
const MensalistasCheckbox = React.forwardRef<
...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      // Tamanho dobrado para mensalistas (8x8 em vez de 4x4)
      "h-8 w-8",
      className
    )}
    {...props}
...
MensalistasCheckbox.displayName = CheckboxPrimitive.Root.displayName

export { MensalistasCheckbox }