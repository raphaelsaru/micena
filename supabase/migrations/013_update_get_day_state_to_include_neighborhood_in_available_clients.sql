-- Migration: 013_update_get_day_state_to_include_neighborhood_in_available_clients
-- Description: Atualiza função get_day_state para incluir neighborhood nos clientes disponíveis
-- Date: 2025-01-27

-- Atualizar função get_day_state para incluir neighborhood nos clientes disponíveis também
