-- Migration: 016_update_save_positions_to_include_service_fields
-- Description: Atualiza função save_positions para incluir campos has_key e service_type
-- Date: 2025-01-27

-- Atualizar função save_positions para incluir campos de serviço
