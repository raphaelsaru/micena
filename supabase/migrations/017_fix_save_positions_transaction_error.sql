-- Migration: 017_fix_save_positions_transaction_error
-- Description: Corrige erro de transação na função save_positions removendo BEGIN/COMMIT/ROLLBACK explícitos
-- Date: 2025-01-27

-- Corrigir função save_positions removendo BEGIN/COMMIT/ROLLBACK explícitos
