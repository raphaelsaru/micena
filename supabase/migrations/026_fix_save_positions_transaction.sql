-- Migration: 026_fix_save_positions_transaction
-- Description: Corrige função save_positions removendo gerenciamento manual de transação
-- Date: 2025-01-27

-- Atualizar função save_positions removendo gerenciamento manual de transação
